<nav class="navbar navbar-expand-lg navbar-dark bg-gradient-dark fixed-top">
    <div class="container-fluid my-2">
        <a class="navbar-brand fw-bold" href="{{ route('landing') }}">
            <img height="24"
                src="https://upload.wikimedia.org/wikipedia/commons/c/cf/Logo_of_the_Ministry_of_Public_Works_and_Housing_of_the_Republic_of_Indonesia.svg"
                alt="">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a title="Informasi" class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
            ...
            <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item @auth dropdown @endauth">
                    ...
                    @else
                        <a title="Informasi" class="nav-link dropdown-toggle" href="#" id="navUser" role="button"
