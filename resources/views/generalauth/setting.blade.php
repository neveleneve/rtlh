                    ...
                    <form action="{{ route('updatesetting') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" class="form-control mb-3" id="username" value="{{ Auth::user()->username }}" readonly>
                            </div>
                            <div class="col-12 col-lg-6">
                                <label for="name">Nama</label>
                                <input type="text" class="form-control mb-3" id="name" value="{{ Auth::user()->name }}" readonly>
                            </div>
                        </div>
